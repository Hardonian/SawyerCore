...
import { CompressionEngine, estimateTokens, type OptimizationModelCandidate } from '../../src/runtime/compression/index.js';
import { RecursivePromptSystem, type PromptFragment } from '../../src/runtime/prompts/index.js';
...
describe('CompressionEngine', () => {
  ...
  it('selects low-power q4 candidates only when available and constrained', () => {
    ...
    const candidates: OptimizationModelCandidate[] = [
