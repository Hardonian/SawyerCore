...
import { recommendProfile } from '../runtime/onboarding.js';
...
writeFileSync('.env.sawyer.example', ['VLLM_BASE_URL=http://localhost:8000/v1', 'LITELLM_BASE_URL=http://localhost:4000/v1', 'LLAMACPP_BASE_URL=http://localhost:8081', 'CLOUD_API_KEY=', 'LITELLM_API_KEY=', 'SAWYER_AI_RECOMMENDATIONS=false'].join('\n'));
