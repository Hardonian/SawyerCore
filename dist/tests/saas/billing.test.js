...
describe('Billing System', () => {
    ...
    describe('Task Usage Recording', () => {
        it('records task usage with correct metadata', async () => {
            const records = await billing.recordTaskUsage('test-tenant', 'run-123', 5000, 1500);
        ...
        it('records agent run usage correctly', async () => {
            const record = await billing.recordAgentRunUsage('test-tenant', 'agent-run-456', 120000, 5);
        ...
        it('records API call usage correctly', async () => {
            const record = await billing.recordApiCall('test-tenant', 'api-call-789', 250);
