...
describe('Tenant Isolation', () => {
    ...
    describe('Resource Isolation', () => {
        it('enforces resource partitions', async () => {
            await isolationController.createContext('tenant-a', 'sk_a', ['read'], {
                maxConcurrentTasks: 10,
                maxStorageBytes: 1_000_000_000,
                maxApiCallsPerMinute: 100,
                maxAgents: 5
        ...
        it('prevents cross-tenant resource access', async () => {
            ...
            await isolationController.createContext('tenant-b', 'sk_b', ['read'], {
                maxConcurrentTasks: 50,
                maxStorageBytes: 5_000_000_000,
                maxApiCallsPerMinute: 500,
                maxAgents: 20
    ...
    describe('Tenant Context', () => {
        it('creates and validates tenant contexts', async () => {
            const context = await isolationController.createContext('tenant-a', 'sk_a', ['read', 'write'], {
                maxConcurrentTasks: 10,
                maxStorageBytes: 1_000_000_000,
                maxApiCallsPerMinute: 100,
                maxAgents: 5
