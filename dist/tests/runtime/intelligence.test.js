...
import { DecisionEngine, PatternEngine, PredictionSystem } from '../../src/intelligence/index.js';
const task = {
    id: 'intel-1',
    type: 'chat',
...
function run(provider, success, latencyMs, costUsd, sequence, errorMessage = null) {
    return {
