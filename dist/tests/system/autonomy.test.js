...
describe('Autonomy System Integration', () => {
    it('should process a task end-to-end through the autonomy loop', async () => {
        ...
        const orchestrator = new WorkflowOrchestrator(engine, taskDetector, intentResolver, healthAggregator, eventBus);
        const loop = new AutonomyLoop(orchestrator, taskDetector, healthAggregator, selfHealer, systemState, eventBus, scheduleRegistry, { tickIntervalMs: 10 });
        // Enqueue a task
